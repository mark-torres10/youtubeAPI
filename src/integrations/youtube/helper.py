...
def create_channel_dataclass_instance(channel_metadata: Dict) -> YoutubeChannel:
...
def flatten_video(video: YoutubeVideo) -> Dict:
    ...
    return {
        **{"video_id": video.video_id, "synctimestamp": video.synctimestamp},
